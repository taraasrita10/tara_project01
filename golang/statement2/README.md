...
This is a list manager built in Go, which performs the actions of adding, removing, checking whether a word exists in the list and listing out the list. The program runs in a loop.
